 ...
 * 
 * Please add code if needed. Feel free to change instance variables
 * to public if more convenient.
 */
public class Vertex {
	
    private int id; // index in vertex array, should match positions array
    
	private HalfEdge e = null;
	private Vector3f pos = null;
	private Vector3f norm = null;
	
	private ArrayList<HalfEdge> vertexEdges = new ArrayList<>();
	...
	//Please note that here I maintain an array list for every vertex, which contains any half edges pointing to this vertex.
	//I will use this array list to find opposite half edges.
	public void addFromEdge(HalfEdge e0){
		this.vertexEdges.add(e0);
	}
	
	public HalfEdge findFromEdge(int i) {
		return vertexEdges.get(i);
	}
	
	public int fromEdgeSize() {
    ...
    // Return midpoint between this and other, normal is non-unit
    public Vertex getAverage(Vertex other) {
        assert((pos != null) && (norm != null) && 
        ...
        return new Vertex(id, x/2, y/2, z/2, nx/2, ny/2, nz/2);
    }
